...
const COLOR_SCHEMES = [
  ...
  { value: "green", label: "Green", colors: ["#2ca02c", "#98df8a", "#c4e8c4"] },
  {
    value: "orange",
    label: "Orange",
    colors: ["#ff7f0e", "#ffbb78", "#ffd4a3"],
  },
  {
    value: "purple",
    label: "Purple",
    colors: ["#9467bd", "#c5b0d5", "#d6c7dd"],
  },
];
...
export function CustomDashboardBuilder({
  ...
  const renderWidgetPreview = (widget: DashboardWidget) => {
    ...
    return (
      <div
        key={widget.id}
        className={`absolute rounded-lg border bg-white shadow-sm transition-all duration-200 ${selectedWidget?.id === widget.id ? "shadow-md ring-2 ring-blue-500" : "hover:shadow-md"} ${isDragging && selectedWidget?.id === widget.id ? "opacity-50" : ""} ${!widget.isVisible ? "opacity-30" : ""} `}
        style={{
      ...
      >
        <div className="flex h-full flex-col p-4">
          ...
          <div className="flex flex-1 items-center justify-center rounded border-2 border-dashed border-gray-200 bg-gray-50">
  ...
  return (
    <div className="flex h-full flex-col">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                ...
                <Tabs defaultValue="analytics" className="w-full">
                  ...
                  {["analytics", "predictions", "team", "custom"].map(
                    category => (
                      <TabsContent
                        key={category}
                        value={category}
                      ...
                      >
                        <div className="grid gap-4 md:grid-cols-2">
                          {WIDGET_TYPES.filter(
                            widget => widget.category.toLowerCase() === category
                          ).map(widget => {
      ...
      <div className="flex-1 overflow-auto bg-gray-50">
        <div className="p-4">
          <div
            className="relative min-h-[600px] rounded-lg border bg-white"
            style={{
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={
                      selectedWidget.config.refreshInterval?.toString() || ""
                    }
                    onValueChange={value =>
                      updateWidget(selectedWidget.id, {
                        config: {
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    id="show-grid"
                    checked={selectedWidget.config.showGrid || false}
                    onCheckedChange={checked =>
                      updateWidget(selectedWidget.id, {
