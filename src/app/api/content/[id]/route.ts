    ...
    if (
      ...
      if (fullContent) {
        ...
        const metaDescription =
          body.meta_description || fullContent.meta_description;
        const focusKeywords =
          body.focus_keywords || fullContent.focus_keywords || [];

        updateData["seo_score"] = calculateSEOScore(
          title,
          content,
          metaDescription,
          focusKeywords
